# Generated by Powerlevel10k configuration wizard on 2022-12-30 at 15:58 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|helmfile|flux|fluxctl|stern|kubeseal|skaffold'
